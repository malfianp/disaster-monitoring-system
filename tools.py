...
def get_X_prediksi(data, date):
    data_history = data.loc[data['date'] <= date].head(400).sort_values(by=['date']).reset_index(drop=True) # 288+108=396, 400>396
...
def get_info_banjir(y_klasifikasi, X, y_pred_status):
